...
import com.tulingxueyuan.mall.component.trade.alipay.service.impl.AlipayMonitorServiceImpl;
import com.tulingxueyuan.mall.component.trade.alipay.service.impl.AlipayTradeServiceImpl;
import com.tulingxueyuan.mall.component.trade.alipay.service.impl.AlipayTradeWithHBServiceImpl;
...
public class TradeServiceImpl implements TradeService {
    ...
    public CommonResult tradeQrCode(Long orderId, Integer payType) {
        //订单信息
        OrderDetailDTO detail= omsOrderService.getOrderDetail(orderId);
        if(detail==null){
            throw new IllegalArgumentException("订单id参数异常");
        }
        //判断当前订单是否待支付、是否超过了订单的支付时间
        ...
        if(between>normalOrderOvertime){
